...
<p align="center">
  ...
  <a href="https://www.testmuai.com/support/docs/hyperexecute-getting-started/"><img src="https://img.shields.io/badge/HyperExecute-Benchmarking-orange.svg?style=for-the-badge&labelColor=000" alt="HyperExecute Benchmarking"></a>
...
1. Clone this repository:
    ```bash
    git clone https://github.com/LambdaTest/hyperexecute-lt-standard-benchmarking
    cd hyperexecute-lt-standard-benchmarking
    ```
...
- The test file used is `hyperexecute.py`.
- The YAML configuration file used is `hyperexecute.yaml`.
- To trigger via GitHub Actions, use the workflow file `hyperexecute.yml`.
- To trigger actions for mobile benchmarking, use `mobile.yml`.
...
For HyperExecute runs, you can enable the tunnel capability in your `hyperexecute.yaml` file by setting `tunnel: true`.
